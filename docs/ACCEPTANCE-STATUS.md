# macOS 1.0.3 acceptance status

Status date: 15 September 2026

## Current audited release candidate

- Source: parent commit `184f7e2a3027ebbbf8fe4603b67982691f96c411` (`Harden the Lite emergency stop`), exported to the dedicated repository as `edd83570ad1a788610dae7d1b1744c9d5cfe3246`.
- Package: `release/1.0.3/AIDOO Whisper Lite_1.0.3_aarch64.dmg`.
- SHA-256: `b69cfa9ee34f0ea771b4ff12563b3a746399910ffb631e613c6765bb72121981`.
...
- `npm run release:mac` completed successfully from a clean tree at the exact local `lite-v1.0.3` source tag.
...
- Upload the exact audited 1.0.3 DMG and matching checksum to the AIDOO website together with the privacy, support and release-notes pages.
