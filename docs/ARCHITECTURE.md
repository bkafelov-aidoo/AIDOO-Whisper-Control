...
The overlay receives state snapshots and progress events. It never owns recording state. Closing the main window hides it while the tray and global shortcut remain active. Quit is explicit in the menu bar.
